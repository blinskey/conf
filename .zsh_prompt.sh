...
#
# Colors have been manually edited.
#
...
function __promptline {
  ...
  # <color> is a 256-color terminal value #
  #########################################
  ...
  local a_bg="${wrap}48;5;172${end_wrap}"
  local a_sep_fg="${wrap}38;5;172${end_wrap}"

  # User
  local b_fg="${wrap}38;5;234${end_wrap}"
  local b_bg="${wrap}48;5;110${end_wrap}"
  local b_sep_fg="${wrap}38;5;110${end_wrap}"

  # Path
  local c_fg="${wrap}38;5;234${end_wrap}"
  local c_bg="${wrap}48;5;186${end_wrap}"
  local c_sep_fg="${wrap}38;5;186${end_wrap}"

  # Warning
  local warn_fg="${wrap}38;5;234${end_wrap}"
  local warn_bg="${wrap}48;5;203${end_wrap}"
  local warn_sep_fg="${wrap}38;5;203${end_wrap}"

  # Version control
  local y_fg="${wrap}38;5;234${end_wrap}"
  local y_bg="${wrap}48;5;147${end_wrap}"
  local y_sep_fg="${wrap}38;5;147${end_wrap}"
